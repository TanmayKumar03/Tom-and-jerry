...
function preload() {
    ...
    caty = loadImage("images/cat4.png")
    cats = loadImage("images/cat2.png")
    catz = loadImage("images/cat1.png")
    backs = loadImage("images/garden.png")
    mouses = loadImage("images/mouse3.png")
    mousez = loadImage("images/mouse1.png")
}
function setup(){
